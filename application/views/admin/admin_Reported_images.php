    ...
    <td width="173">
      ...
      <tr>
        <td> 
          <table width="100%" border="1">
            <tr>
              <td colspan="3"><h2>Reported Images</h2></td>
            </tr>
            <?php foreach($images_reports as $image_apl): ?>
            ...
            <tr>
              ...
              <td width="20%" align="center">
              	...
              	<?php echo anchor('admin404500_corps/deactivate_reported_iamge/'.$image_apl->id, 'Deactivate'); ?><br/>
              	<?php echo anchor('admin404500_corps/delete_reported_image/'.$image_apl->id, 'Delete'); ?>
