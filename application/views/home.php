...
<head>
<meta charset="utf-8">
<title>Most Recent | Lolcorps.com</title>
<meta name="description" content="see all the recent funny images">
<meta name="keywords" content="recent, funny images, funny pics, funny, lol, laugh, lolcorps, laughout loud">
<!--// Mobile Metas //-->
    ...
    <div class="inner">
        ...
        <div class="inner shadow">
            ...
            <div class="second-nav">
                <ul>
                    <li><?php echo anchor('../home/most_recent', 'Most Recent', array('class' => 'active'));?></li>
            ...
            <div class="container row">
                <div class="sixteen columns left">
                    <h1 class="heading">Most Recent</h1>
                    <!-- Album Detail Start -->
                        ...
                        <div id="tab-rock">
                                    ...
                                    <?php foreach ($recent_images as $image): ?>
                                        <li>
                                            ...
                                            <h4 class="title"><a href="<?php echo base_url(); ?>view/image/<?php echo $image->id;?>/<?php echo $image->title;?>">
                                            <?php echo substr($image->title, 0, 20); ?>......</a></h4>
